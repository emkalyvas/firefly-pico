...
class CurrencyUtils
{
    ...
    const CURRENCIES = [
        ...
        //Precious Metals
        ["code" => "XAU", "name" => "Troy ounce of gold", "country" => "-"],
        ["code" => "XAG", "name" => "Troy ounce of silver", "country" => "-"],
        ["code" => "XPT", "name" => "Troy ounce of platinum", "country" => "-"],
        ["code" => "XPD", "name" => "Troy ounce of palladium", "country" => "-"],
    ];
